...
def table_pesanan():
    ...
    try: # dicoba terlebih dahulu
        with open("./APD/pesanan.csv", "r") as file: # 'with open' digunakan untuk membuka file external
            mark = False
...
def table_akun() :
    ...
    try: # dicoba terlebih dahulu
        with open("./APD/akun.csv", "r") as file: # 'with open' digunakan untuk membuka file external
            mark = False
            lines = list(csv.reader(file)) # 'lines' digunakan sebagai variable
...
def table_menu():
    ...
    try: # dicoba terlebih dahulu
        with open("./APD/menu.csv", "r") as file: # 'with open' digunakan untuk membuka file external
            mark = False
            lines = list(csv.reader(file)) # 'lines' digunakan sebagai variable
...
def register(username, password, nama, alamat, no_hp, tanggal_lahir, role = "Pengunjung"):
    try: # dicoba terlebih dahulu
        with open("./APD/akun.csv", "a", newline='') as file: # 'with open' digunakan untuk membuka file external
...
def tambah_menu(nama_menu, harga_menu):
    try: # dicoba terlebih dahulu
        with open("./APD/menu.csv", "a", newline='') as file: # 'with open' digunakan untuk membuka file external
            writer = csv.writer(file) # 'writer' digunakan sebagai variable 
...
def ubah_menu(index, menu_baru, harga_baru):
    try: # dicoba terlebih dahulu
        ...
        if 0 <= index < len(lines): # Fungsi ini digunakan untuk mengecek index yang di input user 
            ...
            with open("./APD/menu.csv", "w", newline='') as file: # 'with open' digunakan untuk membuka file external
                writer = csv.writer(file) # 'writer' digunakan sebagai variable 
                writer.writerows(lines) # 'writer.writerow(lines)' digunakan untuk mengganti data pada lines yang dipilih
